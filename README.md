...
> Simple expense tracking-page-app created with React js.

It is a React app that has a Add Transaction, Transaction List and Delete Transaction features. This is just the Front-end of the app, no Back-end.
